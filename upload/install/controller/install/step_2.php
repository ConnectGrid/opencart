...
class ControllerInstallStep2 extends Controller {
	...
	public function index() {
		...
		// admin configs
		if (!is_file(OPENCART_ADMIN_CONFIG_FILE)) {
		...
		$data['catalog_config'] = OPENCART_CONFIG_FILE;
		$data['admin_config']   = OPENCART_ADMIN_CONFIG_FILE;
