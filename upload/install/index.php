...
define ('OPENCART_CONFIG_FILE',       realpath("{$_SERVER['DOCUMENT_ROOT']}/../opencart/config.php"));
define ('OPENCART_ADMIN_CONFIG_FILE', realpath("{$_SERVER['DOCUMENT_ROOT']}/../opencart/admin-config.php"));
...
define('DIR_STORAGE',      realpath("{$_SERVER['DOCUMENT_ROOT']}/../opencart/storage").'/');    // DIR_SYSTEM.'storage/');
define('DIR_IMAGE',        realpath(DIR_STORAGE.'../opencart/image').'/');                      // str_replace('\\', '/', realpath(dirname(__FILE__) . '/../')) . '/image/');
// view
